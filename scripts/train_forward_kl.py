...
from forward_kl_trainer import ForwardKLDPOTrainer
from utils import seed_everything, get_device, clear_cache
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser("TRAIN_DPO_FORWARD_KL_DIVERGENCE")

    parser.add_argument("--train_batch_size", type=int, default=4)
    parser.add_argument("--eval_batch_size", type=int, default=4)
    parser.add_argument("--gradient_accumulation", type=int, default=4)
    parser.add_argument("--seed", type=int, default=42)
    parser.add_argument("--output_dir", type=str, default="./SMOL_DPO_FORWARD_KL")

    args = parser.parse_args()

    print("Training DPO Forward KL Divergence")
    print(f"Args: {args}")
